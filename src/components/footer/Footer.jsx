...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-gray-300 px-6 md:px-16 py-12">
      <div className="max-w-8xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        ...
        <motion.div variants={fadeIn} initial="hidden" whileInView="show" viewport={{ once: true }}>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-white transition">Advertisers</a></li>
            <li><a href="#" className="hover:text-white transition">Publishers</a></li>
          </ul>
        </motion.div>

        {/* Company */}
        <motion.div variants={fadeIn} initial="hidden" whileInView="show" viewport={{ once: true }} transition={{ delay: 0.1 }}>
        ...
        {/* Legal */}
        <motion.div variants={fadeIn} initial="hidden" whileInView="show" viewport={{ once: true }} transition={{ delay: 0.2 }}>
        ...
        {/* Social Media */}
        <motion.div variants={fadeIn} initial="hidden" whileInView="show" viewport={{ once: true }} transition={{ delay: 0.3 }}>
      ...
      >
        <div className="font-bold text-white text-lg tracking-wide">MOBIPERFORM</div>
