        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-1 items-center">
          ...
          <div className="mt-[-70px] md:mt-1">
            ...
            >
              <img
                ...
                alt="Publisher"
               height=""
               width=""                className="w-full rounded-2xl object-cover"
              />
            </motion.div>
          </div>
          ...
          >
            <div className="max-w-[1000px] flex flex-col justify-center items-center ml-0 md:ml-[-70px]">
              ...
              {/* Description */}
              <p className="mt-5 max-w-[500px] sm:mt-6 text-center mx-auto lg:mx-0 text-base sm:text-lg lg:text-xl font-medium text-gray-700 leading-relaxed">
